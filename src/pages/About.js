...
const About = () => {
    return (
        <div className="page-container">
            ...
            <p>When I am not coding you can usually find me in my room watching Youtube or a Futbol game. I also enjoy sleeping and listening to music. I try to also attend as many Mls or Houston Astros Games as possible.</p>
            <p>Take it easy!</p>
        </div>
    );
};
